...
export default function TotalNutrimentsIcon() {
    return (
        <div className={`${utilsStyles.flexColCenter} ${utilsStyles.alignCenter} ${utilsStyles.redBgColor} ${iconStyles.chartIconContainer}`}>
